...
part of 'available_routes_repository.dart';
...
final availableRoutesRepositoryProvider =
  ...
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$availableRoutesRepositoryHash,
  dependencies: null,
...
final availableRoutesProvider =
    AutoDisposeStreamProvider<AvailableRoutes?>.internal(
  availableRoutes,
  name: r'availableRoutesProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$availableRoutesHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
